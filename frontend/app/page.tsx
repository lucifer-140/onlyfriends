...
export default function OnlyFriendsApp() {
  ...
  const handleRunFriend = (friendId: string) => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "dashboard":
        return <DashboardView onTabChange={setActiveTab} onRunFriend={handleRunFriend} />
      case "myfriends":
        return <MyFriendsView onTabChange={setActiveTab} onRunFriend={handleRunFriend} />
      case "library":
        return <LibraryView onTabChange={setActiveTab} onRunFriend={handleRunFriend} />
      case "workspace":
        return <WorkspaceView initialFriendId={selectedFriendId} />
      case "files":
        return <FilesView />
      case "create":
        return <CreateView onFriendCreated={handleRunFriend} />
      default:
        return <DashboardView onTabChange={setActiveTab} onRunFriend={handleRunFriend} />
    }
  }

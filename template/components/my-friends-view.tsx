...
const myDigitalFriends = [
  {
    id: 1,
    name: "Q4 Report Analyzer",
    description: "Analyzes quarterly financial reports and extracts key metrics and trends",
    icon: BarChart3,
    category: "Analytics",
    runs: 45,
    lastUsed: "1 hour ago",
  ...
  },
  {
    ...
    description: "Generates professional email responses for client inquiries using company tone",
    icon: MessageSquare,
  ...
  },
  {
    id: 3,
    name: "NDA Checker",
    description: "Reviews NDAs for standard clauses and flags unusual terms",
    icon: FileText,
    category: "Documents",
    runs: 23,
    lastUsed: "3 days ago",
  ...
  },
  {
    ...
    description: "Compiles weekly team updates into a formatted summary report",
    icon: Sparkles,
    category: "Documents",
    runs: 52,
    lastUsed: "1 week ago",
...
export function MyFriendsView({ onTabChange }: MyFriendsViewProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <div className="rounded-xl border border-border bg-card p-4">
          ...
          <p className="mt-2 text-2xl font-bold text-foreground">
            {Math.round(myDigitalFriends.reduce((acc, f) => acc + f.successRate, 0) / myDigitalFriends.length)}%
          </p>
      ...
      {viewMode === "grid" && filteredFriends.length > 0 && (
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {filteredFriends.map((friend) => {
            const status = statusConfig[friend.status as keyof typeof statusConfig]

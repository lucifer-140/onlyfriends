...
const folders = [
  { id: 1, name: "Contracts", files: 24, size: "156 MB" },
  { id: 2, name: "HR Documents", files: 89, size: "342 MB" },
  { id: 3, name: "Financial Reports", files: 45, size: "234 MB" },
  { id: 4, name: "Sales Materials", files: 67, size: "512 MB" },
  { id: 5, name: "Meeting Notes", files: 156, size: "78 MB" },
]

const recentFiles = [
  {
    id: 1,
    name: "Q4_Vendor_Contract.pdf",
    type: "pdf",
    folder: "Contracts",
    size: "2.4 MB",
    modified: "2 hours ago",
    usedBy: ["Contract Reviewer"],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    size: "8.1 MB",
    modified: "1 week ago",
    usedBy: ["Sales Proposal Generator"],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    usedBy: ["Financial Analyzer", "Budget Helper"],
  },
]
                  ...
                  <div className="flex items-center gap-4">
                    {file.usedBy.length > 0 && (
                      <div className="flex items-center gap-1">
                        ...
                        {file.usedBy.slice(0, 2).map((friend, i) => (
                          <span
                            key={i}
